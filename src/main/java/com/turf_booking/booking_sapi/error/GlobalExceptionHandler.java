...
import com.turf_booking.booking_sapi.error.CustomUserException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BookingUnexpectedException.class})//, SlotAlreadyExists.class, AlreadyExists.class,})
